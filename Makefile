...
so_long: main.c play.c read_map.c get_empty.c exit_game_three.c get_next_line/get_next_line_utils.c get_next_line/get_next_line.c libft/ft_strdup.c libft/ft_strlen.c libft/ft_split.c create_window.c update_map.c draw_the_map.c exit_the_game.c map_checker/map_checker.c exit_game_two.c map_checker/map_checker_two.c map_checker/map_checker_three.c map_checker/map_check_all.c delete.c
