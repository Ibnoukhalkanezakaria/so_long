...
so_long: main.c play.c read_map.c get_next_line/*.c libft/ft_strdup.c libft/ft_strlen.c libft/ft_split.c create_window.c update_map.c draw_the_map.c exit_the_game.c
